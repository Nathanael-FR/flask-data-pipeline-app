...
from insert_data import connect, insert_data
import os
...
def fetch_data(day, month, year) -> None:
    ...
    try :
        ...
        print(f"Data fetched successfully : {os.listdir('./data/')}")
...
def main():
    ...
    # df.to_csv(f"./data/eCO2mix_RTE_{year}-{month}-{day}.csv", index=False)
